...
export default function Home() {
  return (
    <main className='flex flex-col items-center'>
        ...
        <section className=' mb-12 rounded-3xl p-6 bg-slate-600 max-w-fit max-h-max flex flex-row flex-wrap justify-center gap-12'>
          ...
          <div className='p-2 w-fit text-center flex flex-col justify-center items-center'>
            ...
            <a className=' hover:cursor-pointer drop-shadow-md mt-3 rounded-xl p-3 bg-slate-500 hover:bg-slate-700 hover:duration-300'>Download my CV</a>
          </div>
        </section>
        <section className=' mb-9 p-6 bg-slate-700 w-full max-h-max flex flex-col flex-wrap items-center justify-center gap-3'>
            <h3 className=' text-center font-semibold pt-6 pb-3 text-3xl'>Favourite projects I was working on</h3>
          <div>
          <div className=' p-6 my-9 rounded-3xl bg-slate-600 w-fit flex flex-row flex-wrap justify-center items-center gap-12'>
          ...
          <div className=' my-12 rounded-3xl bg-slate-600 p-6 w-fit flex flex-row flex-wrap justify-center items-center gap-12'>
          ...
          <div className='my-12 rounded-3xl bg-slate-600 p-6 w-fit text-center flex flex-row flex-wrap justify-center items-center gap-12'>
